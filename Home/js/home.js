...
const app = async function () {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    <div class="card">
      ...
      <a href = "./Home/singlenews.html?target=${
        news[i].id
  ...
  <div class="card">
    ...
    <a href = "./Home/singleProgram.html?target=${
      programs[i].id
  ...
  <a href="./Home/News.html" class="btn btn-danger more-news w-25 ">ألمزيد من الاخبار</a>
</div>
`;

  programsContainer.innerHTML += `<div class="programs-page-btn">
  <a href="./Home/service.html" class="btn btn-primary w-25">المزيد من ألبرامج</a>
</div>`;
};
